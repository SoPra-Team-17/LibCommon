...
TEST_F(GadgetActionTests, Nugget_Validate) {
    ...
    state.getCharacters().getByUUID(uuid2)->setFaction(spy::character::FactionEnum::PLAYER1);
    ...
    auto g7 = std::make_shared<GadgetAction>(GadgetAction(false, {5, 3}, uuid1, GadgetEnum::NUGGET));
