...
namespace spy::network::messages {
    class EquipmentChoice : public MessageContainer {
        public:
            ...
            explicit EquipmentChoice(util::UUID clientId, std::map<util::UUID, std::set<gadget::GadgetEnum>> equipment);
             ...
             */
            [[nodiscard]] bool validate(RoleEnum playerRole, std::vector<spy::util::UUID> chosenCharacter,
                                        std::vector<spy::gadget::GadgetEnum> chosenGadget) const;
